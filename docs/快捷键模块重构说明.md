...
```
src/renderer/src/core/modules/hotkey/
├── index.ts
...
```typescript
import { useAppHotkeyModule } from "@/core/modules/hotkey/appHotkey";
...
- `src/renderer/src/core/modules/hotkey/index.ts` - 主 Store
- `src/renderer/src/core/modules/hotkey/modules/appHotkey.ts` - 应用内快捷键模块
- `src/renderer/src/core/modules/hotkey/modules/globalHotkey.ts` - 全局快捷键模块
- `src/renderer/src/core/typings/hotkey.ts` - 类型定义
