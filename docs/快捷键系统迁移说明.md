...
1. **src/renderer/src/core/modules/hotkey/index.ts**
...
- `src/renderer/src/core/modules/hotkey/index.ts` - 快捷键主 Store
- `src/renderer/src/core/modules/hotkey/appHotkey.ts` - 应用内快捷键模块
- `src/renderer/src/core/modules/hotkey/globalHotkey.ts` - 全局快捷键模块
- `src/renderer/src/core/typings/hotkey.ts` - 快捷键类型定义（新增事件类型）
- `src/renderer/src/modules/hotkeys/config/hotkey.ts` - 默认快捷键配置
- `src/renderer/src/core/utils/hotkey.ts` - 快捷键工具函数
