...
type AppItem = (RegexSearch | TextSearch | ImgSearch | FileSearch) & {
  /** 应用名称 */
  name: string;
  /** 应用路径 英文 */
  path: string;
...
interface NaimoLog {
   ...
   */
  throw_error(error: any, options?: { title?: string | undefined; } | undefined): void;
...
interface NaimoWindow {
   ...
   * @param options any
   */
  create(url: string, options?: any): Promise<{ success: boolean; viewId?: string | undefined; error?: string | undefined; detached?: boolean | undefined; }>;
...
interface NaimoDb {
   ...
   * @param name string
   */
  put(doc: any, name?: string): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").DbResult>;
   ...
   * @param name string
   */
  get(id: string, name?: string): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").DbDoc | null>;
   ...
   * @param name string
   */
  remove(id: string, name?: string): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").DbResult>;
   ...
   * @param name string
   */
  allDocs(docPrefix?: string | undefined, name?: string): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").DbDoc[]>;
   ...
   * @param name string
   */
  bulkDocs(docs: any[], name?: string): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").DbResult[]>;
   ...
   * @param name string
   */
  putAttachment(id: string, data: Buffer<ArrayBufferLike>, type: string, name?: string): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").DbResult>;
   ...
   * @param name string
   */
  getAttachment(id: string, name?: string): Promise<{ data: Buffer<ArrayBufferLike>; type: string; } | null>;
...
interface NaimoSystem {
   ...
   */
  notify(message: string, title?: string | undefined): Promise<void>;
...
interface NaimoScreen {
   ...
   */
  capture(options?: { sourceId?: string | undefined; } | undefined): Promise<{ success: boolean; filePath?: string | undefined; error?: string | undefined; }>;

  /**
   * 获取屏幕源列表
   * @param options { types: ("screen" | "window")[]; thumbnailSize?: { width: number; height: number; } | undefined; }
   */
  getSources(options: { types: ("screen" | "window")[]; thumbnailSize?: { width: number; height: number; } | undefined; }): Promise<Electron.DesktopCapturerSource[]>;
   ...
   * 获取主显示器信息
   */
  getPrimaryDisplay(): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").Display>;

  /**
   * 获取所有显示器信息
   */
  getAllDisplays(): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").Display[]>;

  /**
   * 获取指定点附近的显示器
   * @param point { x: number; y: number; }
   */
  getDisplayNearestPoint(point: { x: number; y: number; }): Promise<import("E:/Code/Git/naimo_tools/src/shared/typings/naimoApiTypes").Display>;
...
interface NaimoAutomation {
   ...
   * @param html string
   */
  parseHtmlByConfig(config: any, html: string): void;
   ...
   */
  fetchHTML(url: string, asyncConfig?: any): Promise<import("E:/Code/Git/naimo_tools/src/libs/auto-puppeteer/typings").HtmlFetchResult>;
