...
<template>
  ...
  <div class="w-full h-full bg-transparent" :class="{ 'p-2': !isFullscreen }">
    ...
    <div class="w-full bg-transparent relative overflow-hidden h-full transition-all duration-200 flex flex-col"
      ...
      <WindowControlBar :window-title="windowTitle" :window-icon="windowIcon" :is-loading="isLoading"
        :window-id="windowId" :view-id="viewId" :is-fullscreen="isFullscreen" @reattach="handleReattach"
        @minimize="handleMinimize" @maximize="handleMaximize" @close="handleClose"
